...
public class Login {
	...
	// constructor takes in a boolean parameter
	// true = will attempt to login
	// false = not going to login (guest user)
	public Login(boolean loginAttempt) {
		// not logged in by default
		this.isLoggedIn = false;
		
		if (loginAttempt == true) {
			// if user wants to login, check credentials
			if (validateLogin()) {
